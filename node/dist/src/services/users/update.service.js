...
const updateUserService = (user_id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const findUserUsername = yield userRepository.findOneBy({
    ...
    if (data.password) {
      data.password = "bcrypt$".concat(
        yield (0, bcrypt_1.hash)(data.password, 12)
      );
    }
